...
from forms import ContactForm, PostForm, RegisterForm, LoginForm, CommentForm
...
def single_post(id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            flash('You cannot comment on this post because you are not logged in')
            return redirect(url_for('login'))
...
class Users(UserMixin, db.Model):
    ...
    comments = db.relationship('Comments', backref='comment_author') 
